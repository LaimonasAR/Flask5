...
class KeitimoForma(FlaskForm):
    slaptazodis = PasswordField("Dabartinis slaptažodis", [DataRequired()])
    naujas_slaptazodis = PasswordField("Naujas Slaptažodis", [DataRequired()])
    patv_naujas_slapt = PasswordField(
        "Pakartokite slaptažodį",
        [EqualTo("naujas_slaptazodis", "Slaptažodis turi sutapti.")],
    )
